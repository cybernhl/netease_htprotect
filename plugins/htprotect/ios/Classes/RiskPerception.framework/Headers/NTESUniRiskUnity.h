...
// 白盒解密 V2 密文字符串
extern int ___safeCommFromServer(int alg, int timeout, unsigned char *inputDataString, int dataSize, unsigned char **out, int *outLen);
// 白盒解密 V2 密文二进制
extern int ___safeCommFromServerByte(int alg, int timeout, unsigned char *inputDataByte, int dataSize, unsigned char **out, int *outLen);
